...
class VisualEditTest extends TestCase
{
    ...
    // -------------------------------------------------------------------------
    // attr() — field= parameter (manual field targeting)
    // -------------------------------------------------------------------------

    public function test_attr_with_field_param_outputs_data_sid_field(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
        ...
        $this->assertSame('data-sid-field="hero_title"', $tag->attr());
    }

    public function test_attr_with_field_param_and_label_outputs_both_attributes(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
            params: ['field' => 'hero_title', 'label' => 'Hero Title'],
        );

        $this->assertSame('data-sid-field="hero_title" data-sid-label="Hero Title"', $tag->attr());
    }

    public function test_attr_with_dot_notation_field_param_outputs_dot_notation(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
        ...
        $this->assertSame('data-sid-field="page_info.author"', $tag->attr());
    }

    public function test_attr_with_field_param_does_not_output_data_sid(): void
    {
        $tag = $this->makeTag(
    ...
    public function test_attr_with_field_param_returns_empty_outside_live_preview(): void
    {
        $tag = $this->makeTag(
            livePreview: false,
            params: ['field' => 'hero_title'],
    ...
    public function test_attr_with_field_param_html_escapes_field_path(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
            params: ['field' => '"><script>'],
    ...
    // -------------------------------------------------------------------------
    // index() — field= parameter (manual field targeting)
    // -------------------------------------------------------------------------

    public function test_index_with_field_param_wraps_content_with_data_sid_field(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
            params: ['field' => 'hero_title'],
    ...
    public function test_index_with_field_param_does_not_output_data_sid(): void
    {
        $tag = $this->makeTag(
            livePreview: true,
            params: ['field' => 'hero_title'],
